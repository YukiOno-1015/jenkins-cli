...
def call(Map args = [:]) {
    ...
    def image = args.get('image', config?.k8s?.image ?: 'nexus-docker-pull.sk4869.info/honoka4869/jenkins-maven-node:latest')
    def imagePullSecret = args.get('imagePullSecret', 'nexus')
