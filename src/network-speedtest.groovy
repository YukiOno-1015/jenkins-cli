...
@groovy.transform.Field String DEFAULT_AGENT_IMAGE = 'nexus-docker-pull.sk4869.info/nicolaka/netshoot:latest'
...
pipeline {
    ...
    parameters {
        string(
            name: 'AGENT_IMAGE',
            defaultValue: 'nexus-docker-pull.sk4869.info/nicolaka/netshoot:latest',
